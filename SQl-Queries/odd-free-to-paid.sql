...
valid_stores AS (
    ...
    WHERE fa.first_activity_date BETWEEN '2026-04-01'
                                     AND '2026-04-30'

      AND cs.created_on < '2026-04-01'
